...
<div class="card blue border-0 shadow-lg p-0 mb-5 rounded">
  <div class="card-body">
    <h1 class="font-weight-bold text-dark text-center">AJOUT D'UN PARTENAIRE</h1>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card shadow-lg p-3 mb-5 bg-white rounded">
                <div class="card-header blue"><h2 class="text-center">INFOS PARTENAIRE </h2></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('partenaire')}}">
                       @csrf
                        ...
                        <div class="form-group row">
                            <label for="date1" class="col-md-4 col-form-label text-md-right">{{ __('LIEU DE NAISSANCE') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="residence" class="col-md-4 col-form-label text-md-right">{{ __('VILLE ET QUARTIER DE RESIDENCE') }}</label>
                       ...
                       <div class="form-group row">
                            <label for="numero_pers" class="col-md-4 col-form-label text-md-right">{{ __('TELEPHONE1') }}</label>
...
-->
                        <div class="form-group row">
                            <label for="numero_pers" class="col-md-4 col-form-label text-md-right">{{ __('TELEPHONE2') }}</label>
