    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card shadow-lg p-3 mb-5 bg-white rounded">
                <div class="card-header blue"><h2 class="text-center">INFOS ACTIVITE</h2></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('partenaire')}}">
                       @csrf
                        ...
                        <div class="form-group row">
                            <label for="numero" class="col-md-4 col-form-label text-md-right">{{ __('MATRICULE') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="date1" class="col-md-4 col-form-label text-md-right">{{ __('STATUTS') }}</label>

                            <div class="col-md-6">
                                <input id="date1" class="@error('date1') is-invalid @enderror" type="text" name="date1">
                                @error('date1')
                                    <span class="invalid-feedback" role="alert" id="missDate">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="date1" class="col-md-4 col-form-label text-md-right">{{ __('SECTION') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="residence" class="col-md-4 col-form-label text-md-right">{{ __('CONSEIL GENERAL') }}</label>

                            <div class="col-md-6">
                                <input id="residence" class="@error('residence') is-invalid @enderror" type="text" name="residence">
                                @error('residence')
                                    <span class="inresidencevalid-feedback" role="alert" id="missDate">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cg" class="@error('cg') is-invalid @enderror" type="text" name="cg">
                                @error('cg')
                                    <span class="inresidencevalid-feedback" role="alert" id="missDate">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="cg" class="col-md-4 col-form-label text-md-right">{{ __('NUMERO TELEPHONE1') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="cg" class="col-md-4 col-form-label text-md-right">{{ __('NUMERO TELEPHONE2') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="cg" class="col-md-4 col-form-label text-md-right">{{ __('DATE DE L'ACTIVITE') }}</label>
